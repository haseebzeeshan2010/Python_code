...
hour = ["Ein","Zwei","Drei","Vier","Funf","Sechs","Sieben","Acht","Neun","Zehn","Elf","Zwolf","Dreizehn","Vierzehn","Funfzehn","Sechzehn","Siebzehn","Achtzehn","Neunzehn","Zwanzig","Ein und Zwanzig","Zwei und Zwanzig","Drei und Zwanzig","Zwolf"]
...
if minutes == 0:
    print(hour[hours-1]+" Uhr")
if minutes == 15:
    print("Viertel nach "+hour[hours-1])
if minutes == 30:
    print("Halb "+ hour[hours])
if minutes == 45:
    print("Viertel vor "+hour[hours])

if minutes > 0 and minutes < 30 and minutes != 15:
    print(minute[minutes-1], "Minuten nach", hour[hours-1])

if minutes <= 59 and minutes > 30 and minutes != 45:
    print(minute[(60-minutes)-1], "Minuten vor", hour[hours])